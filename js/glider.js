window.addEventListener('load', function () {
        ...
        new Glider(document.querySelector('.testando'), {
                slidesToShow: 1,
                slidesToScroll: 5,
                draggable: true,
                dots: '#dots',
        ...
        new Glider(document.querySelector('.testando2'), {
                slidesToShow: 1,
                slidesToScroll: 5,
                draggable: true,
                dots: '#dots',
        ...
        new Glider(document.querySelector('.categorias-glider'), {
                slidesToShow: 8,
                rewind: true,
                slidesToScroll: 5,
                draggable: true,
        ...
        new Glider(document.querySelector('.produtos-mais-vendidos'), {
                slidesToShow: 5,
                rewind: true,
                slidesToScroll: 5,
                draggable: true,
        ...
        new Glider(document.querySelector('.melhores-ofertas-glider'), {
                slidesToShow: 5,
                rewind: true,
                slidesToScroll: 5,
                draggable: true,
        ...
        new Glider(document.querySelector('.tambem-compraram-glider'), {
                slidesToShow: 5,
                rewind: true,
                slidesToScroll: 5,
                draggable: true,
        ...
        new Glider(document.querySelector('.lojas-parceiras-glider'), {
                slidesToShow: 6,
                rewind: true,
                slidesToScroll: 6,
                draggable: true,
        ...
        new Glider(document.querySelector('.produtos-patrocionados-glider'), {
                slidesToShow: 5,
                rewind: true,
                slidesToScroll: 5,
                draggable: true,
        ...
        new Glider(document.querySelector('.menu-glider'), {
                slidesToShow: 5,
                rewind: true,
                slidesToScroll: 5,
                draggable: true,
